    ...
    const parseBlock = (block) => {
      ...
      switch (block.type) {
        ...
        case "heading_3": {
          ...
          const content = parseRichText(block[block.type].rich_text, blockSidenotes);
        ...
        case "to_do":
          ...
          <div class="notion-to-do">
            ...
            <span>${parseRichText(block.to_do.rich_text, blockSidenotes)}</span>
          </div>
        `;
        ...
        case "toggle":
          return `
            <details class="notion-toggle">
              <summary>${parseRichText(block.toggle.rich_text, blockSidenotes)}</summary>
        ...
        case "quote":
          return `<blockquote class="notion-quote">${parseRichText(
            ...
            blockSidenotes
          )}${childrenContent}</blockquote>`;

        case "callout": {
          const icon = block.callout.icon?.emoji || "💡";
          const content = parseRichText(block.callout.rich_text, blockSidenotes);
