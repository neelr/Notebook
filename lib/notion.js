...
.notion-column {
  ...
  `;
    ...
    const getColorClasses = (color) => {
      ...
      return isBackground ? `bg-${baseColor}` : `color-${baseColor}`;
    };
    ...
    const parseBlock = (block) => {
      ...
      switch (block.type) {
        ...
        case "image":
          ...
          return `<img src="${imageUrl}" alt="Notion image" class="notion-image">`;
        ...
        case "callout":
          ...
          <div class="notion-callout">
            ...
            <div class="notion-callout-content">${parseRichText(
